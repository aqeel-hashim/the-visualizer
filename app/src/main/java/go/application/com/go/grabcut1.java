...
public class grabcut1 extends Activity implements OnTouchListener{
    ...
    Mat dst = new Mat();
    final String pathToImage = "/drawable/odel.png";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grabcut1);


        imageView = (ImageView) this.findViewById(R.id.imageView);

        bitmap = BitmapFactory.decodeFile(pathToImage);
        Toast msg = Toast.makeText(grabcut1.this, "Press top left and bottom right of the foreground image", Toast.LENGTH_LONG);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (counter == 0) {
                ...
                Imgcodecs.imwrite("/mnt/sdcard/GRABCUT/ck.png", dst);
                Bitmap jpg = BitmapFactory
                        .decodeFile("/mnt/sdcard/GRABCUT/ck.png");
