...
public class VisualizerPage extends NavigationScreen implements View.OnClickListener {
    static final int CAM_REQUEST = 1234;
    private static final int RESULT_LOAD_IMAGE = 9876;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_visualizer_page, content_frame);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            Intent intent = new Intent(VisualizerPage.this, VisualizerFullActivity.class);
