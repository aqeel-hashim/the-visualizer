...
public class NavigationScreen extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = new Intent(NavigationScreen.this, Homepage.class);
        ...
        }else if (id == R.id.nav_shooping_cart) {
            Intent intent = new Intent(NavigationScreen.this, Cart.class);
            startActivity(intent);
